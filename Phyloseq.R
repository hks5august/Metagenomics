...
#theme_set(theme_bw())
otu_mat<- read.table("https://github.com/PineBiotechOrg/OmicsLogicTraining/blob/master/metagenomics/acne/Acne_Amplicon_Abundance_table.txt", header = TRUE, sep = "\t")
tax_mat<- read.table("https://github.com/PineBiotechOrg/OmicsLogicTraining/blob/master/metagenomics/acne/Acne_Taxonomy_table.txt", header = TRUE, sep = "\t")
samples_df <- read.table("https://github.com/PineBiotechOrg/OmicsLogicTraining/blob/master/metagenomics/acne/Acne_SupplementaryTable.txt", header = TRUE, sep = "\t")
...
pdf(file="Barplot1.pdf")
plot_bar(acne, fill = "Phylum")
dev.off()
pdf(file="NMSD-plot1.pdf")
